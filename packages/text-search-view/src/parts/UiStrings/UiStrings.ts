...
export const NoWorkspaceFolder = 'You have not opened or specified a folder. Only open files are currently searched'
...
export const OpenInEditor = 'Open in editor'
export const CopyCurrentSearchResultsToEditor = 'Copy current search results to an editor (Alt+Enter)'
export const ContextLines = 'Context Lines'
export const ToggleContextLines = 'Toggle Context Lines'
...
export const ReplacedManyOccurrencesInManyFilesNoValue = 'Replaced {PH1} occurrences across {PH2} files'
...
export const ReplacedManyOccurrencesInOneFileNoValue = 'Replaced {PH1} occurrences across 1 file'
export const ReplacedOneOccurrenceInOneFile = "Replaced 1 occurrence across 1 file with '{PH1}'"
export const ReplacedOneOccurrenceInOneFileNoValue = 'Replaced 1 occurrence across 1 file'
